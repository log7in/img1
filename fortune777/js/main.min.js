...
function WheelGame(t, e) {
    ...
    this.startLevel = function (t) {
        ...
        r ? (t.hide(), a.spinner.removeClass("wheel__spinner_animated"), s = r, i.spin(s.angle, 0), i.updateSpins(), 0 === s.sound && (o.bg.volume = 0, o.win.volume = 0, o.control.addClass("sound-control_muted")), 2 == s.level ? i.addAchievement(1) : (i.addAchievement(1), i.addAchievement(2), i.showPopup(2))) : setTimeout(function () {
                i.addAchievement(0)
            }, 300), $(".spin-trigger").on("click", function () {
            $(".wheel__button-holder").removeClass("wheel__button-holder_blinking"), t.fadeOut(200), a.spinner.removeClass("wheel__spinner_animated"), e.getActive() ? e.close(function () {
                    i.startLevel(s.level)
                }) : i.startLevel(s.level)
        }), n.find(".wheel").addClass("wheel_animated"), o.control.on("click", function () {
...
!function ($) {
    ...
    var e = new FewModal("#modal-content", {});
    var i = new WheelGame(".game-layout", e);
